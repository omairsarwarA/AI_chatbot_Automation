...
API_URL = "https://fastai.arhamsoft.dev/api/chat/stream"


def test_api_chat():

    # Step 1: Read input messages
    with open("fastCableMessages.json", "r", encoding="utf-8") as f:
    ...
    # Step 3: Save results
    with open("fastCableResponses.json", "w", encoding="utf-8") as f:
